      ...
      <section className="rounded-3xl bg-[#3A4930] text-white p-6 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-5 py-3.5 text-xs font-bold text-white hover:opacity-90 transition shadow min-h-[44px]"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white/10 border border-white/20 px-5 py-3.5 text-xs font-bold text-white hover:bg-white/20 transition min-h-[44px]"
          >
