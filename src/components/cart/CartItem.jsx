  ...
  return (
    <div className="flex items-start justify-between gap-4 py-4 border-b border-gray-100 last:border-0">
      ...
      <div className="flex flex-col items-end justify-between self-stretch min-h-[80px]">
        {/* Quantity controller */}
        <div className="flex items-center gap-2.5 bg-gray-50 border border-gray-100 rounded-lg p-1">
          <button
            onClick={() => updateQty(item.id, item.qty - 1)}
            className="w-6 h-6 rounded-md hover:bg-gray-200 flex items-center justify-center text-gray-600 font-bold transition text-xs"
          >
            -
          </button>
