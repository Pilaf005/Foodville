...
export default function WhyChooseUsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pt-4 pb-[20px] sm:px-6 sm:py-6 space-y-16">
      ...
      {/* Hero Banner Section */}
      <section className="relative overflow-hidden rounded-3xl bg-border-muted text-white p-8 sm:p-12 shadow-md">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#fff_1px,transparent_1px)] [background-size:16px_16px]"></div>
        <div className="relative z-10 max-w-2xl space-y-4">
          <span className="inline-block rounded-full bg-white/10 px-3 py-1 text-xs font-bold tracking-wider text-gold uppercase">
      ...
      {/* Our Story Section */}
      <section className="rounded-3xl bg-border-muted/5 border border-border-muted/15 p-6 sm:p-10 space-y-5">
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="rounded-2xl border border-cardline bg-white overflow-hidden shadow-sm">
              <button
                ...
                className="w-full text-left p-5 flex items-center justify-between font-bold text-xs text-ink hover:bg-cream/20 transition focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-surface-raised min-h-[44px]"
              >
                <span>{faq.q}</span>
      ...
      {/* Contact CTA Strip */}
      <section className="rounded-3xl bg-border-muted text-white p-6 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-5 py-3.5 text-xs font-bold text-white hover:opacity-90 transition shadow min-h-[44px] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-surface-raised"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white/10 border border-white/20 px-5 py-3.5 text-xs font-bold text-white hover:bg-white/20 transition min-h-[44px] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-surface-raised"
          >
