...
export default function CategoryPage({ params: paramsPromise }) {
  ...
  return (
    <div className="pb-[20px] sm:pb-8">
      ...
      {id === "bulk" && (
        <div
          className="mt-4 sm:mt-6 mb-6 rounded-3xl p-5 sm:p-7 text-white shadow-md relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-5 border border-olive/30 bg-cover bg-center"
        ...
        >
          ...
          <div className="w-full md:w-auto shrink-0 z-10">
            <Link
              href="/bulk-order"
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-olive-dark font-extrabold text-xs sm:text-sm shadow-lg hover:bg-stone-100 transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-surface-raised min-h-[44px]"
            >
      ...
      <div className="sticky top-[57px] sm:relative z-20 bg-cream/95 backdrop-blur px-4 sm:px-0 -mx-4 sm:mx-0 -mt-1.5 sm:-mt-3.5 py-3 sm:pt-2 sm:pb-3 flex items-center justify-between border-b border-cardline shadow-sm sm:shadow-none">
        ...
        <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-semibold text-muted uppercase tracking-wider select-none">
          <Link href="/" className="hover:text-olive flex items-center gap-1 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-surface-raised rounded">
