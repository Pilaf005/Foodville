      ...
      >
        ...
        <div className="flex-1 overflow-y-auto pb-4 bg-gray-50">
          ...
          <div className="px-5 py-4 space-y-3">
            {[
              { icon: <HomeIcon size={16} color="#D97706" />,  label: "Address",  value: liveCompleteAddress || "—" },
              { icon: <PinIcon size={16} color="#D97706" />,    label: "Area",     value: liveArea || "—" },
              { icon: <BuildingIcon size={16} color="#D97706" />, label: "City",   value: liveCity || "—" },
              { icon: <PeopleIcon size={16} color="#D97706" />, label: "Receiver", value: `${name}${phone ? `, ${phone}` : ""}` || "—" },
